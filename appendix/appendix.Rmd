...
- Covariates
  + **Heterogeneous Effects**: We use the variable `natscale`, a Nationalism Attachment Scale, for heterogeneous effects.
...
- Which outcomes and subgroup analysis were specified prior to the experiment?
  + In the paper, we used a National Attachment Scale as heterogeneous effects. The National Attachment Scale consists of the following questions:
    + _XXXX._
    + _XXXX._
